<div class="row">
    <div class="col-md-8">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control" name="subtitle" id="title" value="{{ $subtitle }}">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-10">
            <textarea name="content" id="content" rows="30" class="form-control">
                {{ $content }}
            </textarea>
            </div>
        </div>
    ...
    <div class="col-md-4">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-8">
                <textarea type="text" class="form-control" name="meta_description" id="meta_description" rows="6">
                    {{ $meta_description }}
                </textarea>
            </div>
        </div>
